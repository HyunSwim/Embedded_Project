...
void initLED(void)
{
    P10_IOCR0.U &= ~(0x1F << PC1_BIT_LSB_IDX);     // reset P10_IOCR0 PC2

    P10_IOCR0.U |= 0x10 << PC1_BIT_LSB_IDX;        // set P10.2 push-pull general output
}
...
void initCCU61(void)
{
    ...
    SRC_CCU6_CCU61_SR0.U |= 0x0B << SRPN_BIT_LSB_IDX;   // set priority 0x0B

    SRC_CCU6_CCU61_SR0.U &= ~(0x3 << TOS_BIT_LSB_IDX);  // CPU0 service T12 PM interrupt

    SRC_CCU6_CCU61_SR0.U |= 0x1 << SRE_BIT_LSB_IDX;     // SR0 enabled

    CCU61_TCTR0.B.T13CLK = 0x2;     // f_CCU6 = 50 MHz, prescaler = 1024
    CCU61_TCTR0.B.T13PRE = 0x1;     // prescaler enable
    CCU61_T13PR.B.T13PV = 49999 - 1;
    CCU61_TCTR4.B.T13STR = 0x1;
    CCU61_T13.B.T13CV = 0x0;
    CCU61_IEN.B.ENT13PM = 0x1;
    CCU61_INP.B.INPT13 = 0x1;       // SR1
    SRC_CCU6_CCU61_SR1.B.SRPN = 0x0C;
    SRC_CCU6_CCU61_SR1.B.TOS = 0x1;
    SRC_CCU6_CCU61_SR1.B.SRE = 0x1;
    CCU61_TCTR4.B.T13RS = 0x1;
}
...
void initGTM(void)
{
    ...
    GTM_TOM0_TGC0_GLB_CTRL.B.UPEN_CTRL1 |= 0x4;
    GTM_TOM0_TGC0_ENDIS_CTRL.B.ENDIS_CTRL1 |= 0x4;
    GTM_TOM0_TGC0_OUTEN_CTRL.B.OUTEN_CTRL1 |= 0x4;
    ...
    GTM_TOUTSEL7.U &= ~(0x3 << SEL1_BIT_LSB_IDX);
...
void initUSonic(void)
{
    P02_IOCR4.U &= ~(0x1F << PC5_BIT_LSB_IDX);       // reset P02_IOCR4 PC6
    ...
    P02_IOCR4.U |= 0x10 << PC5_BIT_LSB_IDX;        // set P02.6 push-pull general output            [Trig]
